...
int main() {
  ...
  //for insertion using chaining
   ...
   // fgets(string,50,stdin);
    ...
    key=index%size;
    printf("\nIndex of %s = %d \t Key = %d ",string,index,key);
  ...
  case 2:
    ...
    //for probing deletion needs to be modified
    for(i=0;i<size;i++) {
  ...
  case 3:
    ...
    case 1:
      ...
      while(1) {
        ...
        if(tkey==key) {
          printf("\nNo more space or this probing gives the same key forever.  : ");
          break;
        }
      }
      for (i=0;i<size;i++)
    ...
    case 2:
      ...
      while(1) {
        ...
        if(tkey==key) {
          printf("\nNo more space or this probing gives the same ky forever.");
          break;
        }
      }
      for (i=0;i<size;i++)

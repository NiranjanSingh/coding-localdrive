...
def updateHand(hand, word):
    ...
    for k in word:
       # for i in range(hand.get(k,0)):
        newHand[k]=  newHand.get(k,0)-1
	#	newHand[k]=
...
def isValidWord(word, hand, wordList):
    ...
    for k in newHand:
        if newHand.get(k,0) != hand.get(k,0) and newHand.get(k,0) > hand.get(k,0):
           return False
...
def playGame(wordList):
   ...
   # displayHand(hand)
   # print updateHand(hand,raw_input("enter any word :"))
